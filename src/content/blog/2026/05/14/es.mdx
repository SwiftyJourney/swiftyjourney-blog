...
Requiere hardware moderno (**M4 o A18** en adelante) y genera un overhead significativo, por lo que está diseñado para grabaciones cortas y muy dirigidas. Perfecto para responder: "¿esta función se ejecutó o no?" o "¿qué camino exacto tomó la ejecución dentro de este framework?"
...
- **Processor Trace** → Cada instrucción | Overhead alto | Determinístico | Solo M4/A18+
...
Allocations, Leaks y el Memory Graph Debugger — las herramientas de Instruments para cazar problemas de memoria. Vamos a conectar todo lo que aprendimos en la Parte 2.5 sobre malloc, free y ARC con las herramientas que te dejan ver esos procesos en tu app real. Nos vemos ahí.
</Callout>
