...
- **Tipo asociado** — `associatedtype Item` vuelve genérico un protocolo; los conformadores lo rellenan (a menudo inferido); la razón por la que existe `some` ([#15](/es/blog/swift-cero-experto-tipos-opacos))
