...
Here `any Error` means "some value whose concrete type conforms to `Error`, decided at runtime" — the `any` keyword signals type erasure; we'll meet it properly with [protocols in #13](/en/blog/swift-zero-expert-protocols).
