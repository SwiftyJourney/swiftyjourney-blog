...
Puedes hacer override de un failable `init?` con uno **nonfailable** `init` (una subclass puede ser más estricta y garantizar el éxito), pero **no** al revés. También existe una variante `init!` rara vez usada — puedes ignorarla con tranquilidad por ahora; los opcionales se cubren en el #11.
</Callout>
